...
const MOCK_TECHNO_EVENTS: TechnoEvent[] = [
  ...
  {
    title: 'Audiodrome Sessions - Charlotte de Witte',
    description: 'Legendary Belgian techno artist at Audiodrome Turin',
    ...
    latitude: 45.0705,
    longitude: 7.6272,
    lineup: ['Charlotte de Witte', 'Local Residents'],
    genres: ['Techno', 'Industrial Techno'],
    capacity: 800,
    source: 'mock',
    source_url: 'https://www.audiodrome-torino.it/charlotte-de-witte',
    ticket_url: 'https://xceed.me/en/torino/events',
    official_site: 'https://www.audiodrome-torino.it'
  },
  {
    title: 'Audiodrome Sessions - Adam Beyer',
    description: 'Swedish techno legend at Audiodrome',
    ...
    latitude: 45.0705,
    longitude: 7.6272,
    lineup: ['Adam Beyer', 'Bart Skils', 'Local Residents'],
    genres: ['Techno', 'Deep Techno'],
    capacity: 800,
    source: 'mock',
    source_url: 'https://www.audiodrome-torino.it/adam-beyer',
    ticket_url: 'https://xceed.me/en/torino/events',
    official_site: 'https://www.audiodrome-torino.it'
  },
  {
    title: 'Audiodrome Fridays - DJ Richie Hawtin',
    description: 'Every Friday at Audiodrome with international DJs',
    ...
    latitude: 45.0705,
    longitude: 7.6272,
    lineup: ['Richie Hawtin', 'Local Techno Residents'],
    genres: ['Techno', 'Minimal Techno'],
    capacity: 800,
    source: 'mock',
    source_url: 'https://www.audiodrome-torino.it/fridays',
    ticket_url: 'https://xceed.me/en/torino/events',
    official_site: 'https://www.audiodrome-torino.it'
  },
  {
    title: 'Audiodrome Sessions - Ben Klock',
    description: 'Berlin techno icon at Audiodrome Turin',
    ...
    latitude: 45.0705,
    longitude: 7.6272,
    lineup: ['Ben Klock', 'Alex Acid', 'Local Residents'],
    genres: ['Techno', 'Raw Techno'],
    capacity: 800,
    source: 'mock',
    source_url: 'https://www.audiodrome-torino.it/ben-klock',
    ticket_url: 'https://xceed.me/en/torino/events',
    official_site: 'https://www.audiodrome-torino.it'
  },
  {
    title: 'Audiodrome Presents - Amelie Lens',
    description: 'Brussels techno queen at Audiodrome',
    ...
    latitude: 45.0705,
    longitude: 7.6272,
    lineup: ['Amelie Lens', 'Nur Jaber', 'Local Residents'],
    genres: ['Techno', 'Acid Techno'],
    capacity: 800,
    source: 'mock',
    source_url: 'https://www.audiodrome-torino.it/amelie-lens',
    ticket_url: 'https://xceed.me/en/torino/events',
    official_site: 'https://www.audiodrome-torino.it'
  },
  {
    title: 'Audiodrome Sessions - Ellen Allien',
    description: 'Berlin electronic pioneer at Audiodrome',
    ...
    latitude: 45.0705,
    longitude: 7.6272,
    lineup: ['Ellen Allien', 'Stephan Bodzin', 'Local Residents'],
    genres: ['Techno', 'Experimental'],
    capacity: 800,
    source: 'mock',
    source_url: 'https://www.audiodrome-torino.it/ellen-allien',
    ticket_url: 'https://xceed.me/en/torino/events',
    official_site: 'https://www.audiodrome-torino.it'
  },
  {
    title: 'Audiodrome Sessions - Nina Kraviz',
    description: 'Russian techno empress at Audiodrome Turin',
    ...
    latitude: 45.0705,
    longitude: 7.6272,
    lineup: ['Nina Kraviz', 'Trent Cantrelle', 'Local Residents'],
    genres: ['Techno', 'Minimal Techno'],
    capacity: 800,
    source: 'mock',
    source_url: 'https://www.audiodrome-torino.it/nina-kraviz',
    ticket_url: 'https://xceed.me/en/torino/events',
    official_site: 'https://www.audiodrome-torino.it'
  },
  {
